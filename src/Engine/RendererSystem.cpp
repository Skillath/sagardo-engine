        ...
        const float deltaTime)
    {
        world
            ...
            {            
                ...
                auto model = GlmUtils::Identity; // make sure to initialize matrix to identity matrix first
                auto view = GlmUtils::Identity;
                ...
                const auto modelLoc = glGetUniformLocation(shaderProgram.GetId(), "model");
                const auto viewLoc  = glGetUniformLocation(shaderProgram.GetId(), "view");
